...
const config = {
     apiKey: "AIzaSyDWnCqNOghvt7eKDlc7Mxc-8k2gng_0Af4",
  authDomain: "medidores-sabinas.firebaseapp.com",
  databaseURL: "https://medidores-sabinas.firebaseio.com",
  projectId: "medidores-sabinas",
  storageBucket: "medidores-sabinas.appspot.com",
  messagingSenderId: "32200861128",
  appId: "1:32200861128:web:daceb25a16c3e64dd2ccfd",
  measurementId: "G-8GNV33XT1Y"
...
var cars_Ref = firebase.database().ref('/LAMPARAS_E4vsab');


var dataConductores = firebase.database().ref('/LAMPARAS_E4vsab');
...
var pedidos_Ref = firebase.database().ref('/RPUMEDIDOR_E4sab');
